'use client';
import { ONETIME, PURCHASED } from '@constants/index';
...
import { shouldOpenModalLogin } from '@shared-redux/features/user';
...
import { getConfigProV2, IPriceConfig } from '@shared-utils/paypal';
        ...
        <div className="flex items-center justify-center">
          {prices.map((price, i) => (
            <ItemPrice
              ...
              key={i}
              active={active && price.planId === active.planId ? true : false}
