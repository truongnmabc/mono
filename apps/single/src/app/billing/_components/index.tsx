...
import { selectInAppPurchasedInfo } from '@shared-redux/features/payment.reselect';
...
import ProPackage from '@single/app/get-pro/_components/proPackage';
        ...
        <div className="pro-background">
          {inAppSubscriptions.length > 0 && (
            <div className="alert-in-app-purchased">
              <Alert />
              You made your purchase on our mobile app. If you want to change or
              cancel your current plan, please use the app to take action
            </div>
          )}
          <h1>Account Info</h1>
          {!!userInfo && (
