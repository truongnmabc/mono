...
import { endTest } from '@shared-redux/features/game';
import {
  selectCurrentTopicId,
  selectListQuestion,
} from '@shared-redux/features/game.reselect';
import { shouldOpenSubmitTest, testState } from '@shared-redux/features/tests';
import finishCustomTestThunk from '@shared-redux/repository/game/finish/finishCustomTest';
import finishDiagnosticThunk from '@shared-redux/repository/game/finish/finishDiagnostic';
import finishFinalThunk from '@shared-redux/repository/game/finish/finishFinal';
import finishPracticeThunk from '@shared-redux/repository/game/finish/finishPracticeTest';
