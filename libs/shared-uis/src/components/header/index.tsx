...
const HeaderApp = ({ appInfo }: { appInfo: IAppInfo }) => {
  ...
  return (
    <div className="w-full">
      ...
      {isMobile && isPathInList(pathname || '', listPageNotHeader) ? null : (
        <div
          className={clsx(
        ...
        >
          <div className="py-2 w-full z-0 h-full max-w-page">
            <Grid2 container>
              ...
              >
                <LogoHeader appShortName={appInfo.appShortName} />
              </Grid2>
              <Grid2
                size={{
                  xs: 4,
