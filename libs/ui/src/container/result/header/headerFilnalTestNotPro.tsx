...
const HeaderFilnalTestNotPro = () => {
  ...
  const handleTryAgain = useCallback(async () => {
    dispatch(initFinalTestThunk({ id: 1 }));
  ...
  return (
    <div className="w-full bg-white rounded-xl sm:p-6 flex justify-between">
      <div
...
export default HeaderFilnalTestNotPro;
